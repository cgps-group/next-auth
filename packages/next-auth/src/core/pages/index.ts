...
export default function renderPage(params: RenderPageParams) {
  ...
  function send({ html, title, status }: any): OutgoingResponse {
    return {
      ...
      body: `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1.0"><style>${css()}</style><link rel="stylesheet" href="/styles/nextjs-auth-page.css" /><title>${title}</title></head><body class="__next-auth-theme-${
